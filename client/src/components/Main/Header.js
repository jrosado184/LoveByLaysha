      ...
      <div className='bg-pink-200 w-full h-16 shadow-md sticky top-0 z-20 dark:bg-neutral-900 desktop:h-48 desktop:static'>
        <div className='w-full py-[1.4%] flex desktop:block'>
          {localStorage.getItem("token") ? (
            <div className='flex'>
              <img
                className='user-image ml-2 w-11 h-11 rounded-full border-2 border-white md:ml-9 desktop:w-32 desktop:h-32'
                src={user}
                alt=''
              />
            </div>
            ...
            <img
              className='user-image ml-2 w-14 h-12 my-1 rounded-full border-2 border-white md:ml-12 desktop:w-32 desktop:h-32'
              src={laysha}
              alt=''
            />
          )}
