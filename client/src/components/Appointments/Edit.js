      ...
      <div className='md:flex'>
        ...
        <div className='md:w-[60%]'>
          <select
            ...
            className='w-[88%] h-10 my-4 border-2 border-pink-300 pl-2 rounded-full shadow-md dark:border-neutral-900 bg-neutral-700 text-neutral-100 md:ml-6'
          >
          ...
          <input
            data-testid='name'
            className='pl-3 my-6 w-[88%] h-10 rounded-full border-2 border-pink-300 shadow-md dark:border-neutral-900 bg-neutral-700 text-neutral-100 md:ml-6'
            type='text'
            placeholder='Name'
            name='client_name'
          ...
          <select
            ...
            className={
              !info.client_refill
                ? 'w-[88%] h-10 my-4 border-2 border-pink-300 pl-2 rounded-full shadow-md dark:border-neutral-900 bg-neutral-700 text-neutral-100 md:ml-6'
                : 'hidden'
            }
          >
          ...
          <label className='flex items-center text-neutral-100'>
            <input
              data-testid='rinput'
              name='client_refill'
          ...
          <select
            ...
            className={
              info.client_refill
                ? 'w-[88%] h-10 mb-1 border-2 border-pink-300 pl-2 rounded-full md:ml-6 dark:border-neutral-900 bg-neutral-700 text-neutral-100'
                : 'hidden'
            }
          >
          ...
          <label className='flex items-center my-4 dark:text-neutral-100 md:ml-6'>
            ...
            />
            <p>Soak Off</p>
            <p className='ml-48 text-pink-300 dark:text-neutral-100'>$10</p>
          </label>
          <label className=' my-2 md:ml-6 dark:text-neutral-100'>
            ...
            <textarea
              ...
              onChange={handleChange}
              className='w-[88%] h-20 pl-2 border-2 border-pink-400 dark:border-neutral-900 bg-neutral-700 text-neutral-100 md:ml-6'
            />
          </label>
          <div>
            ...
            <label className='flex items-center gap-2 dark:text-neutral-100 md:ml-6'>
              <input
            ...
            <input
              ...
              data-testid='bookbtn'
              className='w-24 h-8 my-6 ml-28 border-2 border-rose-300 bg-pink-100 text-rose-500 rounded-full dark:text-neutral-100 dark:bg-neutral-700 dark:border-neutral-900 sm2:ml-[70%] md:ml-[74%] lg:ml-[80%]'
              type='submit'
              value='Save'
